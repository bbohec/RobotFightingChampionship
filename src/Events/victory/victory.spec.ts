...
feature(featureEventDescription(Action.victory), () => {
    serverScenario(`${Action.victory} 1`, victoryEvent(EntityId.match, EntityId.playerA),
        ...
        , [
            ...
            (game, adapters) => eventsAreSent(TestStep.And, adapters, 'server', [
                drawEvent(EntityId.playerA, new Physical(EntityId.victory, victoryPosition, ShapeType.victory, true)),
                drawEvent(EntityId.playerB, new Physical(EntityId.defeat, defeatPosition, ShapeType.defeat, true))
            ])
        ])
    serverScenario(`${Action.victory} 2`, victoryEvent(EntityId.match, EntityId.playerB),
        ...
        , [
            ...
            (game, adapters) => eventsAreSent(TestStep.And, adapters, 'server', [
                drawEvent(EntityId.playerB, new Physical(EntityId.victory, victoryPosition, ShapeType.victory, true)),
                drawEvent(EntityId.playerA, new Physical(EntityId.defeat, defeatPosition, ShapeType.defeat, true))
            ])
        ])
})
