...
export class AttackingSystem extends ArtithmeticSystem {
    onGameEvent (gameEvent: GameEvent): Promise<void> {
        ...
        const phasingComponent = this.componentRepository.retrieveComponent(retrieveReference(playerEntityReference, EntityType.match), 'Phasing')
        ...
        const attackerPhysical = this.componentRepository.retrieveComponent(attackerId, 'Physical')
        const targetPhysical = this.componentRepository.retrieveComponent(targetId, 'Physical')
