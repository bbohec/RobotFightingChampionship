...
export class AttackingSystem extends ArtithmeticSystem {
    onGameEvent (gameEvent: GameEvent): Promise<void> {
        ...
        const phasingComponent = this.componentRepository.retrievePhasing(retrieveReference(playerEntityReference, EntityType.match))
        ...
        const attackerPhysical = this.componentRepository.retrievePhysical(attackerId)
        const targetPhysical = this.componentRepository.retrievePhysical(targetId)
