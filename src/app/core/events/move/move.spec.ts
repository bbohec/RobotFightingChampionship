...
feature(Action.move, () => {
    serverScenario(`${Action.move} 1 - Robot Move Horizontaly`, moveEvent(EntityIds.playerA, EntityType.robot, EntityIds.playerARobot, EntityIds.cellx1y2),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerARobotPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
            .makeEntity(EntityIds.playerATower).withPhysical(playerATowerFirstPosition(gridFirstCellPosition), ShapeType.tower, true).withEntityReferences(EntityType.tower).save()
            .makeEntity(EntityIds.playerARobot).withPhysical(playerARobotFirstPosition(gridFirstCellPosition), ShapeType.robot, true).withEntityReferences(EntityType.robot).save()
            .makeEntity(EntityIds.cellx1y2).withPhysical(position(1, 2), ShapeType.cell, true).save()
        , [
    ...
    serverScenario(`${Action.move} 3 - Robot Move Diagonally`, moveEvent(EntityIds.playerA, EntityType.robot, EntityIds.playerARobot, EntityIds.cellx1y1),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerARobotPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
            .makeEntity(EntityIds.playerATower).withPhysical(position(1, 2), ShapeType.tower, true).withEntityReferences(EntityType.tower).save()
            .makeEntity(EntityIds.playerARobot).withPhysical(playerARobotFirstPosition(gridFirstCellPosition), ShapeType.robot, true).withEntityReferences(EntityType.robot).save()
            .makeEntity(EntityIds.cellx1y1).withPhysical(position(1, 1), ShapeType.cell, true).save()
        , [
            thereIsServerComponents(TestStep.Given, [
                makePhasing(EntityIds.match, playerARobotPhase()),
                makeEntityReference(EntityIds.match, EntityType.match, new Map([[EntityType.player, [EntityIds.playerA]]])),
    ...
    serverScenario(`${Action.move} 4 - Can't Move Game Event - Tower of other player already on destination cell`, moveEvent(EntityIds.playerA, EntityType.robot, EntityIds.playerARobot, EntityIds.cellx2y2),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerARobotPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA, EntityIds.playerB]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
            .makeEntity(EntityIds.playerB).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerBTower]], [EntityType.match, [EntityIds.match]]])).save()
            .makeEntity(EntityIds.playerATower).withPhysical(playerATowerFirstPosition(gridFirstCellPosition), ShapeType.tower, true).save()
            .makeEntity(EntityIds.playerARobot).withPhysical(playerARobotFirstPosition(gridFirstCellPosition), ShapeType.robot, true).save()
            .makeEntity(EntityIds.playerBTower).withPhysical(position(2, 2), ShapeType.tower, true).save()
            .makeEntity(EntityIds.cellx2y2).withPhysical(position(2, 2), ShapeType.cell, true).save()
    ...
    serverScenario(`${Action.move} 5 - Can't Move Game Event - Tower of same player already on destination cell`, moveEvent(EntityIds.playerB, EntityType.robot, EntityIds.playerBRobot, EntityIds.cellx2y2),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerBRobotPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA, EntityIds.playerB]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.match, [EntityIds.match]]])).save()
            ...
            .makeEntity(EntityIds.playerATower).withPhysical(playerATowerFirstPosition(position(0, 0)), ShapeType.tower, true).save()
            .makeEntity(EntityIds.playerBRobot).withPhysical(position(1, 1), ShapeType.robot, true).save()
            .makeEntity(EntityIds.playerBTower).withPhysical(position(2, 2), ShapeType.tower, true).save()
            .makeEntity(EntityIds.cellx2y2).withPhysical(position(2, 2), ShapeType.cell, true).save()
        , [
            thereIsServerComponents(TestStep.Given, [
    ...
    serverScenario(`${Action.move} 6 - Can't Move Game Event - Robot of the other player already on destination cell`, moveEvent(EntityIds.playerB, EntityType.robot, EntityIds.playerBRobot, EntityIds.cellx2y2),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            ...
            .makeEntity(EntityIds.playerB).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerBTower]], [EntityType.robot, [EntityIds.playerBRobot]], [EntityType.match, [EntityIds.match]]])).save()
            .makeEntity(EntityIds.playerARobot).withPhysical(playerARobotFirstPosition(gridFirstCellPosition), ShapeType.robot, true).save()
            .makeEntity(EntityIds.playerATower).withPhysical(position(3, 4), ShapeType.tower, true).save()
            .makeEntity(EntityIds.playerBRobot).withPhysical(position(1, 2), ShapeType.robot, true).withEntityReferences(EntityType.robot).save()
            .makeEntity(EntityIds.playerBTower).withPhysical(position(1, 1), ShapeType.tower, true).save()
    ...
    serverScenario(`${Action.move} 7 - Can't Move Game Event - No action points`, moveEvent(EntityIds.playerA, EntityType.robot, EntityIds.playerARobot, EntityIds.cellx2y1),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerARobotPhase(0)).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
            .makeEntity(EntityIds.playerATower).withPhysical(playerATowerFirstPosition(gridFirstCellPosition), ShapeType.tower, true).save()
            .makeEntity(EntityIds.playerARobot).withPhysical(playerARobotFirstPosition(gridFirstCellPosition), ShapeType.robot, true).save()
            .makeEntity(EntityIds.cellx2y1).withPhysical(position(2, 1), ShapeType.cell, true).save()
    ...
    serverScenario(`${Action.move} 8 - Can't Move Game Event - Bad Player`, moveEvent(EntityIds.playerB, EntityType.robot, EntityIds.playerARobot, EntityIds.cellx2y1),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerARobotPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA, EntityIds.playerB]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
            .makeEntity(EntityIds.playerB).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerBTower]], [EntityType.robot, [EntityIds.playerBRobot]], [EntityType.match, [EntityIds.match]]])).save()
    ...
    serverScenario(`${Action.move} 9 - Can't Move Game Event - Bad Unit`, moveEvent(EntityIds.playerA, EntityType.robot, EntityIds.playerARobot, EntityIds.cellx2y1),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerATowerPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
            .buildTower(EntityIds.playerATower, position(1, 1)).save()
            .buildRobot(EntityIds.playerARobot, position(24, 24)).save()
            .makeEntity(EntityIds.cellx2y1).withPhysical(position(24, 23), ShapeType.cell, true).save()
        , [
            thereIsServerComponents(TestStep.Given, [
    ...
    serverScenario(`${Action.move} 10 - Auto move on player A Tower Placement Phase`, moveEvent(EntityIds.playerA, EntityType.tower, EntityIds.playerATower, EntityIds.cellx1y1),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerATowerAutoPlacementPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
    ...
    serverScenario(`${Action.move} 11 - Auto move on player A Robot Placement Phase`, moveEvent(EntityIds.playerA, EntityType.robot, EntityIds.playerARobot, EntityIds.cellx2y2),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerARobotAutoPlacementPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
    ...
    serverScenario(`${Action.move} 12 - Auto move on player B Tower Placement Phase`, moveEvent(EntityIds.playerB, EntityType.tower, EntityIds.playerBTower, EntityIds.cellx24y24),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerBTowerAutoPlacementPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA, EntityIds.playerB]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
            .makeEntity(EntityIds.playerB).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerBTower]], [EntityType.robot, [EntityIds.playerBRobot]], [EntityType.match, [EntityIds.match]]])).save()
            .buildTower(EntityIds.playerATower, position(0, 0)).save()
            .buildRobot(EntityIds.playerARobot, position(0, 0)).save()
            ...
            .makeEntity(EntityIds.cellx24y24).withPhysical(playerBTowerFirstPosition(gridFirstCellPosition, gameScreenDimension), ShapeType.cell, true).save()
        , [
            ...whenEventOccured(),
            thereIsServerComponents(TestStep.Then, [
    ...
    serverScenario(`${Action.move} 13 - Auto move on player B Robot Placement Phase`, moveEvent(EntityIds.playerB, EntityType.robot, EntityIds.playerBRobot, EntityIds.cellx24y24),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerBRobotAutoPlacementPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerA, EntityIds.playerB]]])).save()
            .makeEntity(EntityIds.playerA).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerATower]], [EntityType.robot, [EntityIds.playerARobot]], [EntityType.match, [EntityIds.match]]])).save()
            .makeEntity(EntityIds.playerB).withEntityReferences(EntityType.player, new Map([[EntityType.tower, [EntityIds.playerBTower]], [EntityType.robot, [EntityIds.playerBRobot]], [EntityType.match, [EntityIds.match]]])).save()
            .buildTower(EntityIds.playerATower, position(0, 0)).save()
            .buildRobot(EntityIds.playerARobot, position(0, 0)).save()
            ...
            .makeEntity(EntityIds.cellx24y24).withPhysical(playerBRobotFirstPosition(gridFirstCellPosition, gameScreenDimension), ShapeType.cell, true).save()
        , [
            ...whenEventOccured(),
            thereIsServerComponents(TestStep.Then, [
    ...
    serverScenario(`${Action.move} 14 - Tower can't move.`, moveEvent(EntityIds.playerB, EntityType.tower, EntityIds.playerBTower, EntityIds.cellx0y0),
        [], (game, adapters) => () => new EntityBuilder(adapters.componentRepository)
            .makeEntity(EntityIds.match).withPhase(playerBTowerPhase()).withEntityReferences(EntityType.match, new Map([[EntityType.player, [EntityIds.playerB]]])).save()
            ...
            .makeEntity(EntityIds.cellx0y0).withPhysical(position(18, 57), ShapeType.cell, true).save()
        , [
            thereIsServerComponents(TestStep.Given, [
