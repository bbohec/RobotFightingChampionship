...
import { makePhysical, mainMenuPosition, position, defaultJoinSimpleMatchButtonPosition, playerNextTurnButtonPosition, defaultPointerPosition, simpleMatchLobbyPosition, victoryPosition, defeatPosition } from '../../components/Physical'
